...
Por fim, altere as configurações dos arquivos de config, baseado nas configurações
executadas no seu ambiente, nos seguintes arquivos:

- application/config/config.php 
Altere as configurações $config['base_url'], baseado na URL que está sendo executada seu projeto.
